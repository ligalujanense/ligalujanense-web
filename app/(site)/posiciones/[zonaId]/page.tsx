      ...
      {tabla.length > 0 ? (
        <div className="overflow-x-auto rounded-xl border border-neutral-200 shadow-sm">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-marino-oscuro text-white text-left">
            ...
            <tbody className="bg-white">
              {tabla.map((fila, i) => (
                ...
                >
                  <td className="p-3">
                    <span
                      className={`w-6 h-6 inline-flex items-center justify-center rounded-full text-xs font-bold ${
                        i === 0 ? "bg-dorado text-marino-oscuro" : "text-neutral-500"
                      }`}
                    >
                      {i + 1}
                    </span>
                  </td>
                  <td className="p-3 font-semibold text-marino-oscuro">{fila.nombre}</td>
                  ...
                  <td className="p-3 text-center font-extrabold text-marino-oscuro">{fila.pts}</td>
                </tr>
              ))}
            </tbody>
          </table>
